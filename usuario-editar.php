...
<form action="?page=usuario-salvar" method="POST">
    ...
    <div class="mb-3">
        <label>CPF</label>
        <input type="number" value="<?php print $row->cpf_usuario; ?>" name="cpf_usuario" class="form-control">
    </div>
    <div class="mb-3">
        <label>Email</label>
        <input type="email" value="<?php print $row->email_usuario; ?>" name="email_usuario" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="tel" value="<?php print $row->fone_usuario; ?>" name="fone_usuario" class="form-control" required placeholder="(xx) xxxxx-xxxx">
    </div>
    <div class="mb-3">
