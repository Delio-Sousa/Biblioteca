...
switch ($_REQUEST['acao']) {
    case 'cadastrar':
        ...
        $sql = "INSERT INTO usuario (nome_usuario, cpf_usuario, email_usuario, data_nasc_usuario, fone_usuario) VALUES('{$nome_usuario}','{$cpf_usuario}','{$email_usuario}','{$data_nasc_usuario}','{$fone_usuario}')";
        $res = $conn->query($sql);
        if ($res == true) {
